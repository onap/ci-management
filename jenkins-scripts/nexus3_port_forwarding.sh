...
if [[ "${OS_ARCH}" == "aarch64" ]] ;then
  ...
  iptables -t nat -I OUTPUT 1 -p tcp -d ${NODE_IP} --dport 10001 -j DNAT --to-destination ${NODE_IP}:11001
  iptables -t nat -I OUTPUT 1 -p tcp -d ${NODE_IP} --dport 10002 -j DNAT --to-destination ${NODE_IP}:11002
  iptables -t nat -I OUTPUT 1 -p tcp -d ${NODE_IP} --dport 10003 -j DNAT --to-destination ${NODE_IP}:11003
fi
