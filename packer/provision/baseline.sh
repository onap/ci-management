...
rh_systems() {
    ...
    yum install -y unzip xz puppet git git-review perl-XML-XPath tox wget make
...
EOF
    ...
    echo "---> Installing base packages"
    apt-get install unzip xz-utils puppet git git-review libxml-xpath-perl make tox wget
